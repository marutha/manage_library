defmodule ManageLibraryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ManageLibraryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ManageLibraryWeb.Gettext, "errors", msg, opts)
    end
  end
